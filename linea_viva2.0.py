...
.lv-g-wrap { background:#F5F0E8; border:1px solid #D4CFC4; border-radius:12px; overflow:hidden; margin-bottom:32px; font-family:'DM Sans',sans-serif; color:#1A1A14; }
.lv-g-header { background:#2D6A4F; padding:20px 28px 18px; }
.lv-g-header-title { font-family:'Bebas Neue',sans-serif; font-size:22px; letter-spacing:3px; color:#F5F0E8; line-height:1; }
.lv-g-header-sub { font-size:10px; color:rgba(245,240,232,0.6); letter-spacing:1.5px; text-transform:uppercase; margin-top:4px; }
.lv-g-body { padding:28px 32px 36px; }
.lv-g-intro { font-size:13px; color:#6B6456; line-height:1.65; margin-bottom:28px; padding-bottom:20px; border-bottom:1px solid #D4CFC4; }
.lv-g-intro strong { color:#1A1A14; }
.lv-g-seccion { margin-bottom:32px; }
.lv-g-seccion-title { font-family:'Bebas Neue',sans-serif; font-size:15px; letter-spacing:3px; color:#1A1A14; margin-bottom:10px; padding-bottom:7px; border-bottom:2px solid #D4CFC4; }
.lv-g-dim-desc { font-size:13px; color:#6B6456; margin-bottom:14px; line-height:1.55; }
.lv-g-dim-desc strong { color:#1A1A14; }
.lv-g-chips { display:flex; flex-wrap:wrap; gap:10px; margin-bottom:4px; }
.lv-g-chip { display:inline-flex; flex-direction:column; padding:8px 14px; border-radius:8px; font-size:13px; font-weight:600; border:1.5px solid; min-width:160px; }
.lv-g-chip-sub { font-family:'DM Mono',monospace; font-size:10px; font-weight:400; opacity:0.7; margin-top:3px; }
.lv-g-table { width:100%; border-collapse:collapse; font-size:13px; margin-top:6px; border-radius:8px; overflow:hidden; }
.lv-g-table th { font-family:'DM Mono',monospace; font-size:9px; letter-spacing:1.5px; text-transform:uppercase; color:#B8B0A4; font-weight:400; padding:10px 14px; text-align:left; background:#E5E0D6; border-bottom:1px solid #D4CFC4; }
.lv-g-table td { padding:10px 14px; border-bottom:1px solid #D4CFC4; vertical-align:middle; color:#1A1A14; line-height:1.4; background:#EDEAE0; }
.lv-g-table tr:last-child td { border-bottom:none; }
.lv-g-table tr:nth-child(even) td { background:#E8E3D8; }
.lv-g-badge { display:inline-block; padding:4px 10px; border-radius:10px; font-size:12px; font-weight:600; white-space:nowrap; }
.lv-g-block { background:#EDEAE0; border:1px solid #D4CFC4; border-radius:8px; padding:16px 20px; margin-top:10px; }
.lv-g-block-title { font-family:'Bebas Neue',sans-serif; font-size:11px; letter-spacing:2px; color:#6B6456; margin-bottom:12px; }
.lv-g-um-row { display:grid; grid-template-columns:170px 130px 1fr; align-items:baseline; gap:10px; margin-bottom:8px; font-size:13px; }
.lv-g-um-name { font-weight:600; }
.lv-g-um-val { font-family:'DM Mono',monospace; font-size:13px; font-weight:600; color:#2D6A4F; }
.lv-g-um-desc { color:#6B6456; font-size:12px; }
.lv-g-nota { background:#EDEAE0; border:1px solid #D4CFC4; border-left:4px solid #FFB800; border-radius:6px; padding:12px 16px; font-size:12px; color:#6B6456; line-height:1.55; margin-top:18px; }
.lv-g-nota strong { color:#1A1A14; }
.lv-g-code { background:#EDEAE0; padding:1px 6px; border-radius:3px; font-family:'DM Mono',monospace; font-size:12px; }
</style>
